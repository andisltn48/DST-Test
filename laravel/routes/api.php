...
Route::group(['middleware' => ['auth:sanctum','verifiedcheck']], function()
{
...
Route::group(['middleware' => ['auth:sanctum','rolecheck:Admin','verifiedcheck']], function()
{
    ...
    //user
    Route::get('/users',[ManajemenUserController::class,'getAllUser']);
    Route::post('/users/verify/{userId}',[ManajemenUserController::class,'verifyUser']);
});
